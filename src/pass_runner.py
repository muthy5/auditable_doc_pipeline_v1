...
class PassRunner:
    ...
    def run_model_pass(
        ...
        output = self.backend.generate_json(pass_name=pass_name, prompt_text=prompt_text, payload=input_payload)
        self.validate_with_schema(schema_filename=schema_filename, payload=output)
